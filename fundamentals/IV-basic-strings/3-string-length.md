...
Como pode ver acima, não existe o pacote `utf8` isolado. Ele está dentro do grupo `unicode`. Não é possível chamar apenas o grupo `unicode` como pacote. Não existe submódulo no Go.
Da forma como fizemos, importar o `unicode/utf8` importa um pacote chamado `utf8`.
